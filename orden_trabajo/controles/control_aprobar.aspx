...
<% @Import Namespace="System.Data.SqlClient" %>
 ...
 <% @Import Namespace="Newtonsoft.Json.Linq" %> 
    <%   
        ...
        String proveedor = Request.Params["proveedor"].ToString();
        ...
        cnn_sap.Open();
        String valor = "";
        if (proveedor.Equals("LOG"))
        {
            estado = 7;
            estado_texto = "PENDIENTE DE APROBACION LOGISTICA";
        }
        else
        {
            estado = 2;
            estado_texto = "PENDIENTE DE APROBACION MANTENIMIENTO";
        }
        if (notas.Length == 0)
        {
            nota_final = "";
        ...
        try
        {
            if (empresa.Connected == false)
            {
                ...
                else
                {
                    ...
                    Actividad.ActivityType = -1;
                    Actividad.Activity = BoActivities.cn_Other;
                    Actividad.Details = estado_texto;
