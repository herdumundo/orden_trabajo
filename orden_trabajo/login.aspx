    ...
    <div class="card card-login mx-auto mt-5 ">
      ...
      <div class="card-body">
          <form action="logincontrol.aspx" method="post" autocomplete="off">
            ...
            <input class="form-control" id="txt_usuario" name="txt_usuario" type="text" required placeholder="Ingrese su usuario" autocomplete="off"  />
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Contraseña</label>
            <input class="form-control" id="txt_pass" name="txt_pass" type="password" required placeholder="Contraseña" autocomplete="off"  />
          </div>
          <div class="form-group">
