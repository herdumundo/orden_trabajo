  ...
  <table  id="tabla_informe" class="table table-striped table-bordered"   data-row-style="rowStyle" data-toggle="table" data-click-to-select="true">
            ...
            <%
                ...
                try
                {
                    ...
                    rs = new SqlCommand(" select os.descrption,os.status,os.subject,os.callid,sc.U_Id_Usuario ,gm.nombre,gm.area ,maq.resname as maquina,os.createdate " +
               ...
               %>
                 ...
                 <input type="button"   onclick="aprobar_registro(<%=id%>,'<%=descripcion%>','<%=est%>');" class="btn btn-success example2 " value="APROBAR">
                                </td> 
