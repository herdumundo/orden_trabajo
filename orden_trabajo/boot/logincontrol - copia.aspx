                ...
                if (dtb1.Rows.Count == 1)
                {
                    ...
                    while (dr.Read())
                    {
                       ...
                       if (area_user.Equals("CCHA") ||area_user.Equals("CCH") || area_user.Equals("CCHB") || area_user.Equals("OVO")|| area_user.Equals("LABORATORIO")|| area_user.Equals("GCA"))
                        {
                            Session["usuario"] = "cchb";
                        }
                        else if (area_user.Equals("PPR-A") || area_user.Equals("PPR-B")|| area_user.Equals("PPR")|| area_user.Equals("AVI-T")|| area_user.Equals("SANI"))
                        {
                            Session["usuario"] = "ppr";
                        }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                       ...
                       else if (area.Equals("FCART")&&perfil.Equals("1")||area.Equals("FERT") )
                         {
                            Session["correo"] = "nelson@maehara.com.py";
                        }
                    else if (area.Equals("LOG"))
                        {
                            Session["correo"] = "liz@maehara.com.py";
                        }
                        ...
                        else if (area.Equals("LABORATORIO")||area.Equals("GCA") )
                        {
                        ...
                        } else if (area.Equals("FBAL"))
                        {
                            Session["correo"] = "pcheblis@maehara.com";
